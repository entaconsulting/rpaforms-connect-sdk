(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@azure/msal-browser'), require('http'), require('https'), require('url'), require('stream'), require('assert'), require('tty'), require('util'), require('os'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['@azure/msal-browser', 'http', 'https', 'url', 'stream', 'assert', 'tty', 'util', 'os', 'zlib'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.msal, global.require$$1$2, global.require$$2, global.require$$0$1, global.require$$3, global.require$$4, global.require$$1, global.require$$1$1, global.require$$0, global.require$$8));
})(this, (function (msalBrowser, require$$1$2, require$$2, require$$0$1, require$$3, require$$4, require$$1, require$$1$1, require$$0, require$$8) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    const formDefinitions = () => __awaiter(void 0, void 0, void 0, function* () {
        const endpoint = `ConnectDashboard/launchForms`;
        const response = yield getHttpRpaFormsClient().get(endpoint);
        return response.data;
    });

    const create = (formDefinitionId, expiresAt, useExistingDraft, initialValues) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const listUserInstances = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getInstanceUri = (id, expiresAt) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deleteInstance = (id) => __awaiter(void 0, void 0, void 0, function* () {
